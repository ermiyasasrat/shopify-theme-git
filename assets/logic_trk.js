(function() {
    ...
    support_info['global_delay'] = ;
    support_info['purchase_percent'] = '100';
    support_info['store_name'] = 'stories-flooring.myshopify.com';
        ...
        var myAppJavaScript = function($) {
            ...
            $(document).ready(function() {
                ...
                var pageViewFbCall = function(){
                    setTimeout(function(){ FacebookPixel('track', 'PageView'); }, );
                }
                var getPixelIds = function (productIds, type, content) {
                    $.ajax({
                        ...
                        dataType:'JSON',
                        crossDomain: true,
                        data:{'productIds':productIds,storeName:'stories-flooring.myshopify.com'},
                        type:'POST',
                ...
                function getPurEventSetting(){
				    var response;
              		$.ajax({
                        ...
                        crossDomain: true,
                        async:false,
                        data:{'purchaseEvent':'yes',storeName:'stories-flooring.myshopify.com'},
                        type:'POST',
                        success:function(data) {
                          	response = data;
                        },
