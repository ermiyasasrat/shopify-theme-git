class PredictiveSearch extends SearchForm {
	...
	onChange() {
	  ...
	  if (!this.searchTerm || !newSearchTerm.startsWith(this.searchTerm)) {
		...
		var predictiveSearchElement = this.querySelector("#predictive-search-results-groups-wrapper");
		if(predictiveSearchElement) {
			predictiveSearchElement.remove();
		}
	  }
	...
	updateSearchForTerm(previousTerm, newTerm) {
	  ...
	  const currentButtonText = searchForTextElement ? searchForTextElement.innerText : null;
